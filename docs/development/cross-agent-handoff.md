...
- The browser regression fails against the previous installed binary specifically at the missing `Continue in codex` button, and passes the complete handoff against the integrated debug binary.
